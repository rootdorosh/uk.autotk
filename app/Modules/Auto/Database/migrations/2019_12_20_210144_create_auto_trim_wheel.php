...
class CreateAutoTrimWheel extends Migration
{
    ...
    public function up()
    {
        Schema::create('auto_trim_wheel', function (Blueprint $table) {
            ...
            $table->boolean('is_runflat')->default(0);
            $table->boolean('is_steel_wheels')->default(0);
            $table->decimal('front_pressure', 3,1)->unsigned()->nullable();
            $table->decimal('rear_pressure', 3,1)->unsigned()->nullable();
