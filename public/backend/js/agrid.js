    ...
    defaultRowActions: function(params) {
        ...
        if (hasUpdate) {
            actions.push({
                ...
                btn: 'info',
                url: function (column) {
                    return params.baseUrl + '/' + column[idKey] + '/edit';
                }
            });
        }
        ...
        if (hasDestroy) {
            actions.push({
                ...
                btn: 'danger',
                url: function (column) {
                    return params.baseUrl + '/' + column[idKey];
                }
            });
        }
        ...
        return [
            {
                ...
                attribute: 'is_active',
                value: 1,
                url: params.baseUrl + '/bulk-toggle'
            },
            {
                permission: 'update',
                type: 'button',
            ...
            },
            {
                ...
                label: 'Remove',
                action: 'bulkDestroy',
                url: params.baseUrl + '/bulk-destroy'
            }
        ];        
    }
};
